...
public static class OutletSummaryReportExport
{
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(OutletSummaryModel.NetProduction)] = new() { DisplayName = "Net Production", Format = "#,##0.00", Alignment = CellAlignment.Right, IncludeInTotal = true, HighlightNegative = true },
		...
		List<string> columnOrder = showAllColumns
			...
			[
				...
				nameof(OutletSummaryModel.NetProduction),
