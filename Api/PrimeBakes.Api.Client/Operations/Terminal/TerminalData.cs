...
public static class TerminalData
{
	...
	public static async Task<int> SaveTransaction(TerminalModel terminal, int userId, string formFactor, string platform, decimal? latitude, decimal? longitude) =>
		await ApiClient.Post<int>(Helper.MakeRouteFromEndpointFunction(_endpoint, nameof(SaveTransaction)), terminal, new { userId, formFactor, platform, latitude, longitude });
}
