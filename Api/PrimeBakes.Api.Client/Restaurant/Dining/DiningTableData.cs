...
public static class DiningTableData
{
	...
	public static async Task DeleteTransaction(DiningTableModel diningTable, int userId, string formFactor, string platform, decimal? latitude, decimal? longitude) =>
		await ApiClient.Post(Helper.MakeRouteFromEndpointFunction(_endpoint, nameof(DeleteTransaction)), diningTable, new { userId, formFactor, platform, latitude, longitude });
	...
	public static async Task RecoverTransaction(DiningTableModel diningTable, int userId, string formFactor, string platform, decimal? latitude, decimal? longitude) =>
		await ApiClient.Post(Helper.MakeRouteFromEndpointFunction(_endpoint, nameof(RecoverTransaction)), diningTable, new { userId, formFactor, platform, latitude, longitude });
	...
	public static async Task<int> SaveTransaction(DiningTableModel diningTable, int userId, string formFactor, string platform, decimal? latitude, decimal? longitude) =>
		await ApiClient.Post<int>(Helper.MakeRouteFromEndpointFunction(_endpoint, nameof(SaveTransaction)), diningTable, new { userId, formFactor, platform, latitude, longitude });
}
