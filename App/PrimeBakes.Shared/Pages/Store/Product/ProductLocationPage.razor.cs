...
public partial class ProductLocationPage
{
	...
	private async Task ExportMaster(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = ProductLocationExport.ExportMaster(_productLocationOverviews, _locations, await CommonData.LoadCurrentDateTime(), isExcel ? ReportExportType.Excel : ReportExportType.PDF);
