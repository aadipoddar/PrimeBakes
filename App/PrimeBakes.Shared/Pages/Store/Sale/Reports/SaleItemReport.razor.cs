...
public partial class SaleItemReport : IAsyncDisposable
{
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			var allTransactionOverviews = CommonData.LoadTableDataByDate<SaleItemOverviewModel>(StoreNames.SaleItemOverview, fromDate, toDate, useLocalDB: true);
			var allReturnOverviews = CommonData.LoadTableDataByDate<SaleReturnItemOverviewModel>(StoreNames.SaleReturnItemOverview, fromDate, toDate, useLocalDB: true);
			var allTransferOverviews = CommonData.LoadTableDataByDate<StockTransferItemOverviewModel>(StoreNames.StockTransferItemOverview, fromDate, toDate, useLocalDB: true);
			var allBillOverviews = CommonData.LoadTableDataByDate<BillItemOverviewModel>(RestaurantNames.BillItemOverview, fromDate, toDate, useLocalDB: true);
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = SaleReportExport.ExportItemReport(
