...
public partial class AccountingLedgerReport : IAsyncDisposable
{
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_allTransactionOverviews = await CommonData.LoadReportDataByDate<FinancialAccountingLedgerOverviewModel>(
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = FinancialAccountingReportExport.ExportLedgerReport(
