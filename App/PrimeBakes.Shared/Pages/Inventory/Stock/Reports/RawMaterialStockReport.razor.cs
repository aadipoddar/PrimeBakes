...
public partial class RawMaterialStockReport : IAsyncDisposable
{
	...
	private async Task LoadData()
	{
		...
		_categories = await CommonData.LoadTableDataByStatus<RawMaterialCategoryModel>(InventoryNames.RawMaterialCategory, useLocalDB: true);
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = RawMaterialStockReportExport.ExportSummaryReport(
				_stockSummary,
