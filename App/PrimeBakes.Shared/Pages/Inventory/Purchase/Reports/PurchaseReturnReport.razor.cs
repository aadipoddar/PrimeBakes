...
public partial class PurchaseReturnReport : IAsyncDisposable
{
	...
	private List<PurchaseReturnOverviewModel> _allTransactionOverviews = [];
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_allTransactionOverviews = await CommonData.LoadReportDataByDate<PurchaseReturnOverviewModel>(
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = PurchaseReturnReportExport.ExportReport(
