...
public partial class KitchenIssueReport : IAsyncDisposable
{
	...
	private List<KitchenIssueOverviewModel> _allTransactionOverviews = [];
	private List<KitchenIssueReturnOverviewModel> _allTransactionReturnOverviews = [];
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			var allTransactionOverviews = CommonData.LoadReportDataByDate<KitchenIssueOverviewModel>(
				InventoryNames.KitchenIssueOverview,
				DateOnly.FromDateTime(_fromDate).ToDateTime(TimeOnly.MinValue),
				DateOnly.FromDateTime(_toDate).ToDateTime(TimeOnly.MinValue));
			var allTransactionReturnOverviews = CommonData.LoadReportDataByDate<KitchenIssueReturnOverviewModel>(
	...
	private void MergeTransactionAndReturns() =>
		_transactionOverviews.AddRange(_allTransactionReturnOverviews.Select(kir => new KitchenIssueOverviewModel
		{
			Id = kir.Id,
	...
	private async Task DeleteRecoverTransaction(int id, string transactionNo, bool isRecover)
	{
		...
		try
		{
			...
			{
				var kitchenIssue = await CommonData.LoadTableDataById<KitchenIssueModel>(InventoryNames.KitchenIssue, id)
					?? throw new Exception("Transaction not found.");
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = KitchenIssueReportExport.ExportReport(
