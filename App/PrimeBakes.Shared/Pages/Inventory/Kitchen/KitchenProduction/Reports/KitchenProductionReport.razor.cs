...
public partial class KitchenProductionReport : IAsyncDisposable
{
	...
	private List<KitchenProductionOverviewModel> _allTransactionOverviews = [];
	private List<KitchenProductionReturnOverviewModel> _allTransactionReturnOverviews = [];
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			var allTransactionOverviews = CommonData.LoadReportDataByDate<KitchenProductionOverviewModel>(
				InventoryNames.KitchenProductionOverview,
				DateOnly.FromDateTime(_fromDate).ToDateTime(TimeOnly.MinValue),
				DateOnly.FromDateTime(_toDate).ToDateTime(TimeOnly.MinValue));
			var allTransactionReturnOverviews = CommonData.LoadReportDataByDate<KitchenProductionReturnOverviewModel>(
			...
			await AuditTrailData.SaveAuditTrail(new()
			{
				...
				TableName = InventoryRouteNames.KitchenProductionReport,
	...
	private void MergeTransactionAndReturns() =>
		_transactionOverviews.AddRange(_allTransactionReturnOverviews.Select(kpr => new KitchenProductionOverviewModel
		{
			Id = kpr.Id,
	...
	private async Task DeleteRecoverTransaction(int id, string transactionNo, bool isRecover)
	{
		...
		try
		{
			...
			{
				var kitchenProduction = await CommonData.LoadTableDataById<KitchenProductionModel>(InventoryNames.KitchenProduction, id)
					?? throw new Exception("Transaction not found.");
	...
	private async Task ExportReport(bool isExcel = false)
	{
		...
		try
		{
			...
			var (stream, fileName) = KitchenProductionReportExport.ExportReport(
