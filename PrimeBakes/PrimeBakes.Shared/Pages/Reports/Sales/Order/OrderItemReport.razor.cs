...
public partial class OrderItemReport : IAsyncDisposable
{
    ...
    private async Task DownloadPdfInvoice(int transactionId)
    {
        ...
        try
        {
            ...
            var (pdfStream, fileName) = await OrderInvoicePDFExport.ExportInvoice(transactionId);
    ...
    private async Task DownloadExcelInvoice(int transactionId)
    {
        ...
        try
        {
            ...
            var (excelStream, fileName) = await OrderInvoiceExcelExport.ExportInvoice(transactionId);
