...
public partial class KitchenIssueReport : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await KitchenIssueReportExcelExport.ExportReport(
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await KitchenIssueReportPDFExport.ExportReport(
                    _transactionOverviews,
                    dateRangeStart,
                    dateRangeEnd,
                    _showAllColumns,
    ...
    {
        var kitchenIssue = await CommonData.LoadTableDataById<KitchenIssueModel>(TableNames.KitchenIssue, deleteTransactionId);
