...
public partial class KitchenProductionItemReport : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await KitchenProductionItemReportExcelExport.ExportReport(
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await KitchenProductionItemReportPDFExport.ExportReport(
                    _transactionOverviews,
                    dateRangeStart,
                    dateRangeEnd,
                    _showAllColumns,
    ...
    private async Task DownloadPdfInvoice(int transactionId)
    {
        ...
        try
        {
            ...
            var (fileName, pdfStream) = await KitchenProductionInvoiceExport.ExportInvoice(transactionId, InvoiceExportType.PDF);
    ...
    private async Task DownloadExcelInvoice(int transactionId)
    {
        ...
        try
        {
            ...
            var (fileName, excelStream) = await KitchenProductionInvoiceExport.ExportInvoice(transactionId, InvoiceExportType.Excel);
