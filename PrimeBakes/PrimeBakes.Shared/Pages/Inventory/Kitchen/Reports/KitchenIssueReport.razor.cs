...
public partial class KitchenIssueReport : IAsyncDisposable
{
    ...
    private async Task DownloadSelectedPdfInvoice()
    {
        ...
        try
        {
            ...
            var decodeTransactionNo = await DecodeCode.DecodeTransactionNo(_sfGrid.SelectedRecords.First().TransactionNo, true, false, CodeType.KitchenIssue);
    ...
    private async Task DownloadSelectedExcelInvoice()
    {
        ...
        try
        {
            ...
            var decodeTransactionNo = await DecodeCode.DecodeTransactionNo(_sfGrid.SelectedRecords.First().TransactionNo, false, true,CodeType.KitchenIssue);
    ...
    private async Task ViewSelectedTransaction()
    {
        ...
        var decodedTransactionNo = await DecodeCode.DecodeTransactionNo(_sfGrid.SelectedRecords.First().TransactionNo, false, false, CodeType.KitchenIssue);
