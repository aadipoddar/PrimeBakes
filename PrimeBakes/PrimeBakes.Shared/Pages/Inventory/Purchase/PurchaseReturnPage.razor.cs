...
public partial class PurchaseReturnPage
{
		...
		try
		{
			if (Id.HasValue)
			{
				...
				if (_purchaseReturn is null)
				{
					...
					NavigationManager.NavigateTo(InventoryRouteNames.PurchaseReturn, true);
				}
			}
	...
	private async Task NavigateToTransactionHistoryPage() =>
		await AuthenticationService.NavigateToRoute(InventoryRouteNames.PurchaseReturnReport, FormFactor, JSRuntime, NavigationManager);

	private async Task NavigateToItemReport() =>
		 await AuthenticationService.NavigateToRoute(InventoryRouteNames.PurchaseReturnItemReport, FormFactor, JSRuntime, NavigationManager);
