...
public class KitchenIssueItemMonthlySummaryModel
{
	...
	public DateTime? FirstIssueDateTime { get; set; }
	public DateTime? LastIssueDateTime { get; set; }
	public int MonthsSinceLastIssue { get; set; }
	...
	public decimal AveragePerTransaction => TransactionCount == 0 ? 0 : Math.Round(Total / TransactionCount, 2);
	public decimal AverageRate => TotalQuantity == 0 ? 0 : Math.Round(TotalAmount / TotalQuantity, 2);
	public decimal RateVariancePercent => MinimumRate == 0 ? 0 : Math.Round((MaximumRate - MinimumRate) / MinimumRate * 100, 2);
	...
	public decimal ReturnPercent => TotalQuantity == 0 ? 0 : Math.Round(ReturnQuantity / TotalQuantity * 100, 2);
