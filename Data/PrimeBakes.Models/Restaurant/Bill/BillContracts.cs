...
public sealed record BillInvoiceBundle(
	...
	List<BillItemOverviewModel> Details,
	CompanyModel Company,
	LocationModel Location,
	LedgerModel CustomerLedger,
	DateTime CurrentDateTime);

public sealed record BillThermalBundle(
	BillOverviewModel Bill,
	List<BillDetailModel> Details,
	List<ProductModel> Products,
	CompanyModel Company,
	DateTime CurrentDateTime);

public sealed record KOTThermalBundle(
	BillOverviewModel Bill,
	KOTCategoryModel KOTCategory,
	DateTime CurrentDateTime);

public static class BillCartExtensions
{
	public static List<BillDetailModel> ConvertCartToDetails(this List<BillItemCartModel> cart, int masterId = 0) =>
	...
	public static void ApplyItemFinancialDetails(this List<BillItemCartModel> cart, List<ProductModel> products, List<TaxModel> taxes)
	{
