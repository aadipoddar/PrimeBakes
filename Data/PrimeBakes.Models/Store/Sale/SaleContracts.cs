...
public sealed record SaleInvoiceBundle(
	...
	List<SaleItemOverviewModel> Details,
...
public sealed record SaleReturnInvoiceBundle(
	SaleReturnOverviewModel Transaction,
	List<SaleReturnItemOverviewModel> Details,
	CompanyModel Company,
	LocationModel Location,
	LedgerModel Party,
	DateTime CurrentDateTime);

public sealed record SaleThermalBundle(
	SaleOverviewModel Sale,
