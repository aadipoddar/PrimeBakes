...
public static class KitchenProductionReturnData
{
		...
		SqlDataAccessTransaction sqlDataAccessTransaction = null)
	{
		...
		if (sqlDataAccessTransaction is null)
		{
			(MemoryStream, string)? previousInvoice = update && !recover ? await KitchenProductionReturnInvoiceExport.ExportInvoice(kitchenProductionReturn.Id, InvoiceExportType.PDF) : null;
