CREATE TABLE [dbo].[KitchenIssueReturn]
(
    ...
    CONSTRAINT [FK_KitchenIssueReturn_ToCompany] FOREIGN KEY ([CompanyId]) REFERENCES [Company]([Id]),
    CONSTRAINT [FK_KitchenIssueReturn_ToFinancialYear] FOREIGN KEY ([FinancialYearId]) REFERENCES [dbo].[FinancialYear]([Id]),
    CONSTRAINT [FK_KitchenIssueReturn_ToKitchen] FOREIGN KEY ([KitchenId]) REFERENCES [Kitchen]([Id]),
    CONSTRAINT [FK_KitchenIssueReturn_ToUser] FOREIGN KEY ([CreatedBy]) REFERENCES [User]([Id]),
	CONSTRAINT [FK_KitchenIssueReturn_LastModifiedBy_ToUser] FOREIGN KEY ([LastModifiedBy]) REFERENCES [User]([Id])
)
