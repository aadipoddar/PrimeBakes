...
namespace PrimeBakes.Data.Utils.Mail;
...
internal static class TransactionMailing
{
	...
	private static string GenerateTransactionEmailHtml(TransactionEmailData data)
	{
		...
		{
			NotifyType.Created => $"A new {typeLower} has been recorded in {CommonSecrets.DatabaseName}. A summary is provided below.",
			NotifyType.Updated => $"An existing {typeLower} has been updated. The changes and current details are summarised below.",
			NotifyType.Deleted => $"A {typeLower} has been deleted from {CommonSecrets.DatabaseName}. The details are retained below for your records.",
                ...
                <table role=""presentation"" class=""email-container"" style=""width: 680px; max-width: 100%; border-collapse: collapse; background-color: #ffffff; border: 1px solid #e6e8eb; border-radius: 10px; overflow: hidden; box-shadow: 0 1px 3px rgba(16, 24, 40, 0.06);"">
                    ...
                    <tr>
                        <td class=""pad-header"" style=""padding: 26px 32px; text-align: center; border-bottom: 1px solid #eef0f2;"">
                            <img src=""{CommonSecrets.OnlineFullLogoPath}"" alt=""{CommonSecrets.DatabaseName}"" style=""max-width: 280px; width: 100%; height: auto; display: block; margin: 0 auto;"" />
                        </td>
                    </tr>
                            ...
                            <table role=""presentation"" style=""border-collapse: collapse; margin: 4px 0 8px 0;"">
                                <tr>
                                    <td style=""border-radius: 6px; background-color: #111827;"">
                                        <a href=""{CommonSecrets.AppWebsite}"" style=""display: inline-block; padding: 11px 22px; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600;"">Open in {CommonSecrets.DatabaseName}</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style=""padding: 22px 32px; background-color: #fafafa; border-top: 1px solid #eef0f2;"">
                            <p style=""margin: 0 0 6px 0; color: #9ca3af; font-size: 12px; line-height: 1.6;"">
                                This is an automated notification from {CommonSecrets.DatabaseName}. Please do not reply to this email.
                            </p>
                            <p style=""margin: 0; color: #9ca3af; font-size: 12px; line-height: 1.6;"">
                                © {DateTime.Now.Year} {CommonSecrets.DatabaseName} · Powered by <a href=""{CommonSecrets.AadiSoftWebsite}"" style=""color: #6b7280; text-decoration: none; font-weight: 600;"">AadiSoft</a>
                            </p>
                        </td>
                    </tr>
                </table>
