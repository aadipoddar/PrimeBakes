...
public static class BillReportExport
{
		...
		LocationModel location = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(BillOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(BillOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(BillOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(BillOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(BillOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(BillOverviewModel.CreatedFormFactor),
				nameof(BillOverviewModel.CreatedPlatform),
				nameof(BillOverviewModel.CreatedLatitude),
				nameof(BillOverviewModel.CreatedLongitude),
				nameof(BillOverviewModel.LastModifiedByUserName),
				nameof(BillOverviewModel.LastModifiedAt),
				nameof(BillOverviewModel.LastModifiedFormFactor),
		...
		LocationModel location = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(BillItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(BillItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(BillItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(BillItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(BillItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(BillItemOverviewModel.CreatedFormFactor),
				nameof(BillItemOverviewModel.CreatedPlatform),
				nameof(BillItemOverviewModel.CreatedLatitude),
				nameof(BillItemOverviewModel.CreatedLongitude),
				nameof(BillItemOverviewModel.LastModifiedByUserName),
				nameof(BillItemOverviewModel.LastModifiedAt),
				nameof(BillItemOverviewModel.LastModifiedFormFactor),
