...
public static class SaleReportExport
{
		...
		LocationModel location = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(SaleOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(SaleOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(SaleOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(SaleOverviewModel.CreatedFormFactor),
				nameof(SaleOverviewModel.CreatedPlatform),
				nameof(SaleOverviewModel.CreatedLatitude),
				nameof(SaleOverviewModel.CreatedLongitude),
				nameof(SaleOverviewModel.LastModifiedByUserName),
				nameof(SaleOverviewModel.LastModifiedAt),
				nameof(SaleOverviewModel.LastModifiedFormFactor),
		...
		LedgerModel party = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(SaleItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(SaleItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(SaleItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(SaleItemOverviewModel.CreatedFormFactor),
				nameof(SaleItemOverviewModel.CreatedPlatform),
				nameof(SaleItemOverviewModel.CreatedLatitude),
				nameof(SaleItemOverviewModel.CreatedLongitude),
				nameof(SaleItemOverviewModel.LastModifiedByUserName),
				nameof(SaleItemOverviewModel.LastModifiedAt),
				nameof(SaleItemOverviewModel.LastModifiedFormFactor),
