...
public static class SaleReturnReportExport
{
		...
		LocationModel location = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(SaleReturnOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleReturnOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleReturnOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(SaleReturnOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(SaleReturnOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(SaleReturnOverviewModel.CreatedFormFactor),
				nameof(SaleReturnOverviewModel.CreatedPlatform),
				nameof(SaleReturnOverviewModel.CreatedLatitude),
				nameof(SaleReturnOverviewModel.CreatedLongitude),
				nameof(SaleReturnOverviewModel.LastModifiedByUserName),
				nameof(SaleReturnOverviewModel.LastModifiedAt),
				nameof(SaleReturnOverviewModel.LastModifiedFormFactor),
		...
		LedgerModel party = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(SaleReturnItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleReturnItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(SaleReturnItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(SaleReturnItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(SaleReturnItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(SaleReturnItemOverviewModel.CreatedFormFactor),
				nameof(SaleReturnItemOverviewModel.CreatedPlatform),
				nameof(SaleReturnItemOverviewModel.CreatedLatitude),
				nameof(SaleReturnItemOverviewModel.CreatedLongitude),
				nameof(SaleReturnItemOverviewModel.LastModifiedByUserName),
				nameof(SaleReturnItemOverviewModel.LastModifiedAt),
				nameof(SaleReturnItemOverviewModel.LastModifiedFormFactor),
