...
{
	public static (MemoryStream stream, string fileName) ExportInvoice(SaleReturnInvoiceBundle bundle, InvoiceExportType exportType)
	{
		var (transaction, transactionDetails, company, location, party, currentDateTime) = bundle;
