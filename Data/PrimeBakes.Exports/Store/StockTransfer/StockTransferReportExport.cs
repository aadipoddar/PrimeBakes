...
public static class StockTransferReportExport
{
		...
		LocationModel toLocation = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(StockTransferOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(StockTransferOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(StockTransferOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(StockTransferOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(StockTransferOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(StockTransferOverviewModel.CreatedFormFactor),
				nameof(StockTransferOverviewModel.CreatedPlatform),
				nameof(StockTransferOverviewModel.CreatedLatitude),
				nameof(StockTransferOverviewModel.CreatedLongitude),
				nameof(StockTransferOverviewModel.LastModifiedByUserName),
				nameof(StockTransferOverviewModel.LastModifiedAt),
				nameof(StockTransferOverviewModel.LastModifiedFormFactor),
		...
		LocationModel toLocation = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(StockTransferItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(StockTransferItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(StockTransferItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(StockTransferItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(StockTransferItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(StockTransferItemOverviewModel.CreatedFormFactor),
				nameof(StockTransferItemOverviewModel.CreatedPlatform),
				nameof(StockTransferItemOverviewModel.CreatedLatitude),
				nameof(StockTransferItemOverviewModel.CreatedLongitude),
				nameof(StockTransferItemOverviewModel.LastModifiedByUserName),
				nameof(StockTransferItemOverviewModel.LastModifiedAt),
				nameof(StockTransferItemOverviewModel.LastModifiedFormFactor),
