...
public static class KitchenProductionReportExport
{
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(KitchenProductionOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(KitchenProductionOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.LastModifiedPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.LastModifiedLatitude)] = new() { DisplayName = "Modified Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.LastModifiedLongitude)] = new() { DisplayName = "Modified Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.CreatedUserOffset)] = new() { DisplayName = "Created Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionOverviewModel.LastModifiedUserOffset)] = new() { DisplayName = "Modified Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(KitchenProductionOverviewModel.CreatedFormFactor),
				nameof(KitchenProductionOverviewModel.CreatedPlatform),
				nameof(KitchenProductionOverviewModel.CreatedLatitude),
				nameof(KitchenProductionOverviewModel.CreatedLongitude),
				nameof(KitchenProductionOverviewModel.LastModifiedByUserName),
				nameof(KitchenProductionOverviewModel.LastModifiedAt),
				nameof(KitchenProductionOverviewModel.LastModifiedFormFactor),
				nameof(KitchenProductionOverviewModel.LastModifiedPlatform),
				nameof(KitchenProductionOverviewModel.LastModifiedLatitude),
				nameof(KitchenProductionOverviewModel.LastModifiedLongitude),
				nameof(KitchenProductionOverviewModel.CreatedUserOffset),
				nameof(KitchenProductionOverviewModel.LastModifiedUserOffset),
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(KitchenProductionItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(KitchenProductionItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.LastModifiedPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.LastModifiedLatitude)] = new() { DisplayName = "Modified Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.LastModifiedLongitude)] = new() { DisplayName = "Modified Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.CreatedUserOffset)] = new() { DisplayName = "Created Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenProductionItemOverviewModel.LastModifiedUserOffset)] = new() { DisplayName = "Modified Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(KitchenProductionItemOverviewModel.CreatedFormFactor),
				nameof(KitchenProductionItemOverviewModel.CreatedPlatform),
				nameof(KitchenProductionItemOverviewModel.CreatedLatitude),
				nameof(KitchenProductionItemOverviewModel.CreatedLongitude),
				nameof(KitchenProductionItemOverviewModel.LastModifiedByUserName),
				nameof(KitchenProductionItemOverviewModel.LastModifiedAt),
				nameof(KitchenProductionItemOverviewModel.LastModifiedFormFactor),
				nameof(KitchenProductionItemOverviewModel.LastModifiedPlatform),
				nameof(KitchenProductionItemOverviewModel.LastModifiedLatitude),
				nameof(KitchenProductionItemOverviewModel.LastModifiedLongitude),
				nameof(KitchenProductionItemOverviewModel.CreatedUserOffset),
				nameof(KitchenProductionItemOverviewModel.LastModifiedUserOffset),
