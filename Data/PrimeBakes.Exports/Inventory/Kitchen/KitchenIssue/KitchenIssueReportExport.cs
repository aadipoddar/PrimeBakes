...
public static class KitchenIssueReportExport
{
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(KitchenIssueOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(KitchenIssueOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.LastModifiedPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.LastModifiedLatitude)] = new() { DisplayName = "Modified Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.LastModifiedLongitude)] = new() { DisplayName = "Modified Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.CreatedUserOffset)] = new() { DisplayName = "Created Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueOverviewModel.LastModifiedUserOffset)] = new() { DisplayName = "Modified Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(KitchenIssueOverviewModel.CreatedFormFactor),
				nameof(KitchenIssueOverviewModel.CreatedPlatform),
				nameof(KitchenIssueOverviewModel.CreatedLatitude),
				nameof(KitchenIssueOverviewModel.CreatedLongitude),
				nameof(KitchenIssueOverviewModel.LastModifiedByUserName),
				nameof(KitchenIssueOverviewModel.LastModifiedAt),
				nameof(KitchenIssueOverviewModel.LastModifiedFormFactor),
				nameof(KitchenIssueOverviewModel.LastModifiedPlatform),
				nameof(KitchenIssueOverviewModel.LastModifiedLatitude),
				nameof(KitchenIssueOverviewModel.LastModifiedLongitude),
				nameof(KitchenIssueOverviewModel.CreatedUserOffset),
				nameof(KitchenIssueOverviewModel.LastModifiedUserOffset),
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(KitchenIssueItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(KitchenIssueItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.LastModifiedPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.LastModifiedLatitude)] = new() { DisplayName = "Modified Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.LastModifiedLongitude)] = new() { DisplayName = "Modified Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.CreatedUserOffset)] = new() { DisplayName = "Created Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(KitchenIssueItemOverviewModel.LastModifiedUserOffset)] = new() { DisplayName = "Modified Offset (User)", Format = "#,##0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(KitchenIssueItemOverviewModel.CreatedFormFactor),
				nameof(KitchenIssueItemOverviewModel.CreatedPlatform),
				nameof(KitchenIssueItemOverviewModel.CreatedLatitude),
				nameof(KitchenIssueItemOverviewModel.CreatedLongitude),
				nameof(KitchenIssueItemOverviewModel.LastModifiedByUserName),
				nameof(KitchenIssueItemOverviewModel.LastModifiedAt),
				nameof(KitchenIssueItemOverviewModel.LastModifiedFormFactor),
				nameof(KitchenIssueItemOverviewModel.LastModifiedPlatform),
				nameof(KitchenIssueItemOverviewModel.LastModifiedLatitude),
				nameof(KitchenIssueItemOverviewModel.LastModifiedLongitude),
				nameof(KitchenIssueItemOverviewModel.CreatedUserOffset),
				nameof(KitchenIssueItemOverviewModel.LastModifiedUserOffset),
