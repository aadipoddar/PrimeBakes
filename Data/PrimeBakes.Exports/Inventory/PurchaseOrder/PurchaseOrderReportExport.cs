...
public static class PurchaseOrderReportExport
{
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(PurchaseOrderOverviewModel.CreatedFromPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			...
			[nameof(PurchaseOrderOverviewModel.LastModifiedFromPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		LedgerModel party = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(PurchaseOrderItemOverviewModel.CreatedFromPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			...
			[nameof(PurchaseOrderItemOverviewModel.LastModifiedFromPlatform)] = new() { DisplayName = "Modified Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(PurchaseOrderItemOverviewModel.CreatedFromPlatform),
				nameof(PurchaseOrderItemOverviewModel.LastModifiedByUserName),
				nameof(PurchaseOrderItemOverviewModel.LastModifiedAt),
				nameof(PurchaseOrderItemOverviewModel.LastModifiedFromPlatform),
