...
public static class PurchaseReturnReportExport
{
		...
		CompanyModel company = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(PurchaseReturnOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(PurchaseReturnOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(PurchaseReturnOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(PurchaseReturnOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(PurchaseReturnOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(PurchaseReturnOverviewModel.CreatedFormFactor),
				nameof(PurchaseReturnOverviewModel.CreatedPlatform),
				nameof(PurchaseReturnOverviewModel.CreatedLatitude),
				nameof(PurchaseReturnOverviewModel.CreatedLongitude),
				nameof(PurchaseReturnOverviewModel.LastModifiedByUserName),
				nameof(PurchaseReturnOverviewModel.LastModifiedAt),
				nameof(PurchaseReturnOverviewModel.LastModifiedFormFactor),
		...
		LedgerModel party = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(PurchaseReturnItemOverviewModel.CreatedFormFactor)] = new() { DisplayName = "Created Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(PurchaseReturnItemOverviewModel.CreatedPlatform)] = new() { DisplayName = "Created Platform", Alignment = CellAlignment.Left, IncludeInTotal = false },
			[nameof(PurchaseReturnItemOverviewModel.CreatedLatitude)] = new() { DisplayName = "Created Lat", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			[nameof(PurchaseReturnItemOverviewModel.CreatedLongitude)] = new() { DisplayName = "Created Long", Format = "0.000000", Alignment = CellAlignment.Right, IncludeInTotal = false },
			...
			[nameof(PurchaseReturnItemOverviewModel.LastModifiedFormFactor)] = new() { DisplayName = "Modified Form", Alignment = CellAlignment.Left, IncludeInTotal = false },
		...
		else if (showAllColumns)
		{
			...
			[
				...
				nameof(PurchaseReturnItemOverviewModel.CreatedFormFactor),
				nameof(PurchaseReturnItemOverviewModel.CreatedPlatform),
				nameof(PurchaseReturnItemOverviewModel.CreatedLatitude),
				nameof(PurchaseReturnItemOverviewModel.CreatedLongitude),
				nameof(PurchaseReturnItemOverviewModel.LastModifiedAt),
				nameof(PurchaseReturnItemOverviewModel.LastModifiedByUserName),
				nameof(PurchaseReturnItemOverviewModel.LastModifiedFormFactor),
