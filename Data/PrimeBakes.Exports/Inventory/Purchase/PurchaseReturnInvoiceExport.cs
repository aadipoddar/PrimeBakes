...
{
	public static (MemoryStream stream, string fileName) ExportInvoice(PurchaseReturnInvoiceBundle bundle, InvoiceExportType exportType)
	{
		...
		var columnSettings = new List<InvoiceColumnSetting>
		{
			...
			new(nameof(PurchaseReturnItemOverviewModel.ItemName), "Item", exportType, CellAlignment.Left, 0, 30),
			new(nameof(PurchaseReturnItemOverviewModel.UnitOfMeasurement), "UOM", exportType, CellAlignment.Center, 40, 8),
			new(nameof(PurchaseReturnItemOverviewModel.Quantity), "Qty", exportType, CellAlignment.Right, 40, 10, "#,##0.00"),
			new(nameof(PurchaseReturnItemOverviewModel.Rate), "Rate", exportType, CellAlignment.Right, 50, 12, "#,##0.00"),
			new(nameof(PurchaseReturnItemOverviewModel.DiscountPercent), "Disc %", exportType, CellAlignment.Right, 45, 8, "#,##0.00"),
			new(nameof(PurchaseReturnItemOverviewModel.AfterDiscount), "Taxable", exportType, CellAlignment.Right, 55, 12, "#,##0.00"),
			new("TaxPercent","Tax %", exportType, CellAlignment.Right, 45, 8, "#,##0.00"),
			new(nameof(PurchaseReturnItemOverviewModel.TotalTaxAmount), "Tax", exportType, CellAlignment.Right, 50, 12, "#,##0.00"),
			new(nameof(PurchaseReturnItemOverviewModel.Total), "Total", exportType, CellAlignment.Right, 55, 15, "#,##0.00")
		};
