...
public static class ProductStockReportExport
{
		...
		LocationModel location = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(ProductStockSummaryModel.KitchenProductionReturnStock)] = new() { DisplayName = "Kitchen Production Return", Format = "#,##0.00", Alignment = CellAlignment.Right, IncludeInTotal = true, HighlightNegative = true },
		...
		if (showAllColumns)
			...
			[
				...
				nameof(ProductStockSummaryModel.KitchenProductionReturnStock),
