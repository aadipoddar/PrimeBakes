...
namespace PrimeBakes.Exports.Inventory.Stock;

public static class RawMaterialStockReportExport
{
	public static (MemoryStream stream, string fileName) ExportSummaryReport(
		...
		bool showAllColumns = true)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(RawMaterialStockSummaryModel.KitchenIssueReturnStock)] = new() { DisplayName = "Kitchen Issue Return", Format = "#,##0.00", Alignment = CellAlignment.Right, IncludeInTotal = true, HighlightNegative = true },
		...
		if (showAllColumns)
			...
			[
				...
				nameof(RawMaterialStockSummaryModel.KitchenIssueReturnStock),
	...
	public static (MemoryStream stream, string fileName) ExportDetailsReport(
		...
		DateOnly? dateRangeEnd = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(RawMaterialStockDetailsModel.TransactionNo)] = new() { DisplayName = "Transaction No", Alignment = CellAlignment.Left, IncludeInTotal = false },
