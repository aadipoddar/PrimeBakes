...
public static class StockTransferData
{
    ...
    public static async Task RecoverStockTransferTransaction(StockTransferModel stockTransfer)
    {
        ...
        await SaveStockTransferTransaction(stockTransfer, transactionItemCarts, false);
        await SendNotification.StockTransferNotification(stockTransfer.Id, NotificationType.Recover);
    }

    public static async Task<int> SaveStockTransferTransaction(StockTransferModel stockTransfer, List<StockTransferItemCartModel> stockTransferDetails, bool showNotification = true)
    {
