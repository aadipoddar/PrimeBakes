...
public static class SaleData
{
    ...
    public static async Task DeleteSale(int saleId)
    {
        ...
        await SendNotification.SaleNotification(sale.Id, NotificationType.Delete);
    }
    ...
    public static async Task RecoverSaleTransaction(SaleModel sale)
    {
        ...
        await SaveSaleTransaction(sale, transactionItemCarts, false);
        await SendNotification.SaleNotification(sale.Id, NotificationType.Recover);
    }
    ...
    public static async Task<int> SaveSaleTransaction(SaleModel sale, List<SaleItemCartModel> saleDetails, bool showNotification = true)
    {
        ...
        if (showNotification)
            await SendNotification.SaleNotification(sale.Id, update ? NotificationType.Update : NotificationType.Save);
