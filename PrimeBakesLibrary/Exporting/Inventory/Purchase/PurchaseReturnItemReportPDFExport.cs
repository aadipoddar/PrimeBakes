...
public static class PurchaseReturnItemReportPDFExport
{
        ...
        CompanyModel company = null)
    {
        ...
        {
            [nameof(PurchaseReturnItemOverviewModel.ItemName)] = new() { DisplayName = "Item", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.ItemCode)] = new() { DisplayName = "Code", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.ItemCategoryName)] = new() { DisplayName = "Category", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.TransactionNo)] = new() { DisplayName = "Trans No", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.TransactionDateTime)] = new() { DisplayName = "Trans Date", Format = "dd-MMM-yyyy hh:mm", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.CompanyName)] = new() { DisplayName = "Company", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.PartyName)] = new() { DisplayName = "Party", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.PurchaseReturnRemarks)] = new() { DisplayName = "Purchase Return Remarks", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.Remarks)] = new() { DisplayName = "Item Remarks", IncludeInTotal = false },
            [nameof(PurchaseReturnItemOverviewModel.InclusiveTax)] = new() { DisplayName = "Incl Tax", IncludeInTotal = false },

            [nameof(PurchaseReturnItemOverviewModel.Quantity)] = new()
            {
                DisplayName = "Qty",
                Format = "#,##0.00",
            ...
            [nameof(PurchaseReturnItemOverviewModel.Rate)] = new()
            {
                DisplayName = "Rate",
                Format = "#,##0.00",
                StringFormat = new Syncfusion.Pdf.Graphics.PdfStringFormat
            ...
            [nameof(PurchaseReturnItemOverviewModel.NetRate)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.BaseTotal)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.DiscountPercent)] = new()
            {
                DisplayName = "Disc %",
                Format = "#,##0.00",
                StringFormat = new Syncfusion.Pdf.Graphics.PdfStringFormat
            ...
            [nameof(PurchaseReturnItemOverviewModel.DiscountAmount)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.AfterDiscount)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.SGSTPercent)] = new()
            {
                DisplayName = "SGST %",
                Format = "#,##0.00",
                StringFormat = new Syncfusion.Pdf.Graphics.PdfStringFormat
            ...
            [nameof(PurchaseReturnItemOverviewModel.SGSTAmount)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.CGSTPercent)] = new()
            {
                DisplayName = "CGST %",
                Format = "#,##0.00",
                StringFormat = new Syncfusion.Pdf.Graphics.PdfStringFormat
            ...
            [nameof(PurchaseReturnItemOverviewModel.CGSTAmount)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.IGSTPercent)] = new()
            {
                DisplayName = "IGST %",
                Format = "#,##0.00",
                StringFormat = new Syncfusion.Pdf.Graphics.PdfStringFormat
            ...
            [nameof(PurchaseReturnItemOverviewModel.IGSTAmount)] = new()
            {
            ...
            [nameof(PurchaseReturnItemOverviewModel.TotalTaxAmount)] = new()
            {
                DisplayName = "Tax Amt",
                Format = "#,##0.00",
                HighlightNegative = true,
            ...
            [nameof(PurchaseReturnItemOverviewModel.Total)] = new()
            {
                DisplayName = "Total",
                Format = "#,##0.00",
                HighlightNegative = true,
            ...
            [nameof(PurchaseReturnItemOverviewModel.NetTotal)] = new()
            {
